...
% Strip PDF metadata: compile with pdflatex, then run:
%   exiftool -all= paper_v5_blinded.pdf
% to remove author/creator fields from PDF properties.
...
\usepackage[pdfauthor={},pdfcreator={}]{hyperref}
\usepackage{natbib}
\usepackage{xcolor}
...
\author{[Anonymous]}
\affil{[Affiliation withheld for peer review]}
\date{}
